...
impl Processor {
    pub fn process_deposit_nft(program_id: &Pubkey,accounts: &[AccountInfo],number_of_tokens: u64, price:u64)-> ProgramResult {
        ...
        let nft_vault_address= next_account_info(account_info_iter)?; // nft vault address generated from NFTPREFIX, nft_owner, pda and program id
        ...
        let nft_owner_associated_address = next_account_info(account_info_iter)?; // nft owner associated toekn address
        ...
        invoke(
            &spl_token::instruction::transfer(
                token_program_id.key,
                nft_owner_associated_address.key,
    ...
    pub fn process_buy_nft_token(program_id: &Pubkey,accounts: &[AccountInfo],number_of_tokens: u64, price:u64)-> ProgramResult {
        let account_info_iter = &mut accounts.iter();
